    ...
    <div class="pay-layout">
      ...
      <div class="pay-upload-col">
        <div class="pay-card pay-upload-card">
          ...
          <p class="pay-submit-note">Your spot is reserved for 10 minutes. Complete your payment before the timer ends, or your registration will be automatically cancelled.</p>
        </div>
