...
{ file: 'naturalflush1.png', name: 'None' },
{ file: 'naturalflush2.png', name: 'Soft Pink' },
{ file: 'naturalflush3.png', name: 'Rose Pink' },
{ file: 'naturalflush4.png', name: 'Peach' },
{ file: 'naturalflush5.png', name: 'Apricot' },
{ file: 'naturalflush6.png', name: 'Coral' },
{ file: 'naturalflush7.png', name: 'Soft Mauve' },
{ file: 'naturalflush8.png', name: 'Terracotta' },
{ file: 'naturalflush9.png', name: 'Warm Berry' },
{ file: 'naturalflush10.png', name: 'Cocoa Rose' }
]},
{ id: 'hair', label: 'Hair', folder: 'hair', options: [
{ file: 'hair1.png', name: 'None' },
{ file: 'hair2.png', name: 'Sakura Pink Short Bob' },
{ file: 'hair3.png', name: 'Ice Blue Short Bob' },
{ file: 'hair4.png', name: 'Brown Short Bob' },
{ file: 'hair5.png', name: 'Cherry Red Short Bob' },
{ file: 'hair6.png', name: 'Yellow Spiky Hair' },
{ file: 'hair7.png', name: 'Gray Spiky Hair' },
{ file: 'hair8.png', name: 'Blue Spiky Hair' },
{ file: 'hair9.png', name: 'Red Spiky Hair' },
{ file: 'hair10.png', name: 'Brown Classic Bun' },
{ file: 'hair11.png', name: 'Pink Classic Bun' },
{ file: 'hair12.png', name: 'Yellow Classic Bun' }
...
{ file: 'brows1.png', name: 'None' },
{ file: 'brows2.png', name: 'Soft Arch' },
{ file: 'brows3.png', name: 'Gentle Arch' },
{ file: 'brows4.png', name: 'Natural Arch' },
{ file: 'brows5.png', name: 'Straight' },
{ file: 'brows6.png', name: 'Relaxed' },
{ file: 'brows7.png', name: 'Cute Curve' }
]},
...
{ file: 'blush1.png', name: 'None' },
{ file: 'blush2.png', name: 'Stripe Blush' },
{ file: 'blush3.png', name: 'Cheek Blush' },
{ file: 'blush4.png', name: 'Dot Blush' },
{ file: 'blush5.png', name: 'Side Stripe Blush' }
]},
{ id: 'shoes', label: 'Shoes', folder: 'shoes', options: [
{ file: 'shoes1.png', name: 'None' },
{ file: 'shoes2.png', name: 'Sky Loafers' },
{ file: 'shoes3.png', name: 'Charcoal Loafers' },
{ file: 'shoes4.png', name: 'White Loafers' },
...
{ file: 'top2.png', name: 'Blue Overshirt' },
{ file: 'top3.png', name: 'Stone Overshirt' },
{ file: 'top4.png', name: 'Rose Overshirt' },
{ file: 'top5.png', name: 'Charcoal Tee' },
{ file: 'top6.png', name: 'Cream Polo' },
{ file: 'top7.png', name: 'Blush Polo' },
{ file: 'top8.png', name: 'Sky Stripe' },
{ file: 'top9.png', name: 'Sage Stripe' },
{ file: 'top10.png', name: 'Sage Stripe' },
{ file: 'top11.png', name: 'Beige Shirt' },
{ file: 'top12.png', name: 'Mint Shirt' },
{ file: 'top13.png', name: 'Cherry Raglan' },
{ file: 'top14.png', name: 'Navy Raglan' },
{ file: 'top15.png', name: 'Lime Raglan' },
{ file: 'top16.png', name: 'Cocoa Raglan' },
{ file: 'top17.png', name: 'Slate Tee' },
{ file: 'top18.png', name: 'Matcha Tee' },
{ file: 'top19.png', name: 'Basic Green Shirt' },
{ file: 'top20.png', name: 'Basic Blue Shirt' },
{ file: 'top21.png', name: 'Powder Sailor' },
{ file: 'top22.png', name: 'Pearl Square' },
{ file: 'top23.png', name: 'Moss Frill' },
{ file: 'top24.png', name: 'Aqua Frill' },
{ file: 'top25.png', name: 'Blue White Crop Top' },
{ file: 'top26.png', name: 'Red White Crop Top' },
{ file: 'top27.png', name: 'Grey White Crop Top' }
]},
{ id: 'bottom', label: 'Bottom', folder: 'bottoms', options: [
{ file: 'bottom1.png', name: 'None' },
{ file: 'bottom2.png', name: 'Hunter Green Shorts' },
{ file: 'bottom3.png', name: 'Denim Shorts' },
{ file: 'bottom4.png', name: 'Red Shorts' },
{ file: 'bottom5.png', name: 'Black Shorts' },
{ file: 'bottom6.png', name: 'Cocoa Shorts' },
{ file: 'bottom7.png', name: 'Light Blue Jeans' },
{ file: 'bottom8.png', name: 'White Jeans' },
{ file: 'bottom9.png', name: 'Khaki Skirt' },
{ file: 'bottom10.png', name: 'Sage Skirt' },
{ file: 'bottom11.png', name: 'Denim Skirt' },
{ file: 'bottom12.png', name: 'Plaid Skirt' },
{ file: 'bottom13.png', name: 'Sky Pleated Skirt' },
{ file: 'bottom14.png', name: 'Blush Pleated Skirt' },
{ file: 'bottom15.png', name: 'Cream Pleated Skirt' },
{ file: 'bottom16.png', name: 'Lilac Pleated Skirt' },
{ file: 'bottom17.png', name: 'Cream Wrap Skirt' },
{ file: 'bottom18.png', name: 'Snow Wrap Skirt' }
]},
{ id: 'dress', label: 'Dress', folder: 'dress', options: [
{ file: 'dress1.png', name: 'None' },
{ file: 'dress2.png', name: 'Meadow Frilly Gingham Dress' },
{ file: 'dress3.png', name: 'Blossom Frilly Gingham Dress' },
{ file: 'dress4.png', name: 'Bluebell Frilly Gingham Dress' },
{ file: 'dress5.png', name: 'Pinafore' },
{ file: 'dress6.png', name: 'Collar Dress' },
{ file: 'dress7.png', name: 'Cream Collar' },
...
{ file: 'bg2.png', name: 'Plain White' },
{ file: 'bg3.png', name: 'Soft Blue' },
{ file: 'bg4.png', name: 'Cream Beige' },
{ file: 'bg5.png', name: 'Mint Green' },
{ file: 'bg6.png', name: 'Sunny Meadow' },
{ file: 'bg7.png', name: 'Cozy Room' },
{ file: 'bg8.png', name: 'Minimal Interior' },
{ file: 'bg9.png', name: 'Living Room' },
{ file: 'bg10.png', name: 'Victorian Hall' },
{ file: 'bg11.png', name: 'Carnival Night' },
{ file: 'bg12.png', name: 'Hallowen Street' },
{ file: 'bg13.png', name: 'Fireplace Lounge' }
]},
];
    ...
    <div class="pay-layout">
        ...
        <div class="pay-card">
          ...
          <div id="pay-method-ewallet" class="pay-method-detail" style="display:none">
            <div class="pay-ewallet-list">
              ...
              <div class="pay-ewallet-item"><span class="ewallet-icon">🔵</span><div><div class="ewallet-name">OVO</div><div class="ewallet-num">+62 898 5570 109 a.n Nabhani Najla Salsabila </div></div></div>
              <div class="pay-ewallet-item"><span class="ewallet-icon">🟠</span><div><div class="ewallet-name">Dana</div><div class="ewallet-num">+62 898 5570 109 a.n Nabhani Najla Salsabila </div></div></div>
            </div>
      ...
      <div class="pay-upload-col">
        <div class="pay-card pay-upload-card">
          ...
          <p class="pay-submit-note">Payment required within 10 minutes.</p>
        </div>
