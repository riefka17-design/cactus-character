...
{ file: 'shoes1.png', name: 'Sky Loafers' },
{ file: 'shoes2.png', name: 'Charcoal Loafers' },
{ file: 'shoes3.png', name: 'White Loafers' },
{ file: 'shoes4.png', name: 'Cream Sendal' },
{ file: 'shoes5.png', name: 'Blush Sendal' },
{ file: 'shoes6.png', name: 'None' }
]},
{ id: 'hijab', label: 'Hijab', folder: 'hijab', options: [
{ file: 'hijab1.png', name: 'None' }
]},
{ id: 'top', label: 'Top', folder: 'tops', options: [
{ file: 'top1.png', name: 'Blue Overshirt' },
{ file: 'top2.png', name: 'Stone Overshirt' },
{ file: 'top3.png', name: 'Rose Overshirt' },
{ file: 'top4.png', name: 'Charcoal Tee' },
{ file: 'top5.png', name: 'Cream Polo' },
{ file: 'top6.png', name: 'Blush Polo' },
{ file: 'top7.png', name: 'Sky Stripe' },
{ file: 'top8.png', name: 'Blush Stripe' },
{ file: 'top9.png', name: 'Sage Stripe' },
{ file: 'top10.png', name: 'Lime Raglan' },
{ file: 'top11.png', name: 'Sky Shirt' },
{ file: 'top12.png', name: 'Cherry Raglan' },
{ file: 'top13.png', name: 'Navy Raglan' },
{ file: 'top14.png', name: 'Lime Raglan' },
{ file: 'top15.png', name: 'Cocoa Raglan' },
{ file: 'top16.png', name: 'Slate Tee' },
{ file: 'top17.png', name: 'Matcha Tee' },
{ file: 'top18.png', name: 'None' },
{ file: 'top19.png', name: 'Sky Shirt' },
{ file: 'top20.png', name: 'Powder Sailor' },
{ file: 'top21.png', name: 'Pearl Square' },
{ file: 'top22.png', name: 'Moss Frill' },
{ file: 'top23.png', name: 'Aqua Frill' },
{ file: 'top24.png', name: 'Blue White Crop Top' },
{ file: 'top25.png', name: 'Red White Crop Top' },
{ file: 'top26.png', name: 'Grey White Crop Top' },
{ file: 'top27.png', name: 'None' }
]},
{ id: 'bottom', label: 'Bottom', folder: 'bottoms', options: [
{ file: 'bottom1.png', name: 'Hunter Green Shorts' },
{ file: 'bottom2.png', name: 'Denim Shorts' },
{ file: 'bottom3.png', name: 'Red Shorts' },
{ file: 'bottom4.png', name: 'Black Shorts' },
{ file: 'bottom5.png', name: 'Cocoa Shorts' },
{ file: 'bottom6.png', name: 'Light Blue Jeans' },
{ file: 'bottom7.png', name: 'White Jeans' },
{ file: 'bottom8.png', name: 'Khaki Skirt' },
{ file: 'bottom9.png', name: 'Sage Skirt' },
{ file: 'bottom10.png', name: 'Denim Skirt' },
{ file: 'bottom11.png', name: 'Plaid Skirt' },
{ file: 'bottom12.png', name: 'Sky Pleated Skirt' },
{ file: 'bottom13.png', name: 'Blush Pleated Skirt' },
{ file: 'bottom14.png', name: 'Cream Pleated Skirt' },
{ file: 'bottom15.png', name: 'Lilac Pleated Skirt' },
{ file: 'bottom16.png', name: 'Cream Wrap Skirt' },
{ file: 'bottom17.png', name: 'Snow Wrap Skirt' },
{ file: 'bottom18.png', name: 'None' }
]},
